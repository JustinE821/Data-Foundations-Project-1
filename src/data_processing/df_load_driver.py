...
def get_data_frames():
    ...
    california_date_columns = compute_date_cols(CALIFONIA_COLS)
    ...
    california_df = pd.read_csv(CALIFORNIA_PATH, usecols=CALIFONIA_COLS, nrows=5, parse_dates=california_date_columns, converters=california_converters)
